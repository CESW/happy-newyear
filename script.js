window.onload = function () {
	...
	// 点击音乐图标，控制音乐播放效果
			...
			// 	if(audio.paused){
			// 		audio.play();
			// 		this.setAttribute("class","play");/*置零*/
			// 		//this.style.animationPlayState = "running";/*随时停，只有iPhone6兼容*/
			// 		//this.style.webkitanimationPlayState = "running";/*Android不兼容*/
			// 	}else{			
			// 		audio.pause();
